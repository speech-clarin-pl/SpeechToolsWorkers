...
python2.7 $KALDI_ROOT/tools/phonetisaurus-g2p/src/scripts/phonetisaurus-apply --model /dist/model/default/phonetisaurus/model.fst --lexicon /dist/model/default/phonetisaurus/lexicon.txt --word_list $word_list -p 0.8 > $lexicon
